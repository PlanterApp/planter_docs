...
5. To see the varieties you have marked as favorites, find the plant in the **Plants** list then either select the **Down arrow**{{< screenshot Down-arrow.jpg "Screenshot of the down arrow icon" >}} below the plant, or **filter**{{< screenshot Filter-icon.jpg "Screenshot of the filter icon" >}} the **Varieties** tab for **Favorites**:<br /><br />
