...
2. Select the **Sort**{{< screenshot Sort-icon1.jpg "Screenshot of the sort icon" >}} icon to change the sorting<br /><br />
...
{{< alert icon="🌶️" context="warning" text="Filters also apply to search results. Select **Show all** and de-select **Start inside now, Transplant now, and Sow outside now** to see all results." />}}
