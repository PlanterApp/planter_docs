...
{{< alert icon="🌱" context="info" text="If you change to metric units, plant spacings remain the same- Planter indicates how many plants can be planted in roughly 1/10m²" />}}
